<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'       => 'footer-abt-content',
                'type'     => 'textarea',
                'title'    => __( 'Content Below Footer About', 'din-option' ),
                'desc'     => __( 'Add the content that will appear under the about heading.', 'din-option' ),
                'default'  => '',
            ),
            array(
                'id'       => 'footer-2-heading',
                'type'     => 'text',
                'title'    => __( 'Heading of the second footer area', 'din-option' ),
                'desc'     => __( 'Add a befitting heading here.', 'din-option' ),
                'default'  => 'Our Partners',
            ),
            array(
                'id'       => 'footer-2-content',
                'type'     => 'textarea',
                'title'    => __( 'Content of the second footer area', 'din-option' ),
                'desc'     => __( 'Add the corresponding content.', 'din-option' ),
                'default'  => '',
            ),
            array(
                'id'       => 'footer-3-heading',
                'type'     => 'text',
                'title'    => __( 'Heading of the third footer area', 'din-option' ),
                'desc'     => __( 'Add befitting the heading here.', 'din-option' ),
                'default'  => 'Contact',
            ),
            array(
                'id'       => 'footer-3-content',
                'type'     => 'textarea',
                'title'    => __( 'Content of the third footer area', 'din-option' ),
                'desc'     => __( 'Add the corresponding content.', 'din-option' ),
                'default'  => '',
            ),
            array(
